...
Durante la pausa di revisione puoi anche correggere facoltativamente il **testo narrato** di ogni scena e **spostare i luoghi su una mappa**, oltre a sostituire le immagini. Le modifiche restano nel progetto e vengono applicate con **Continua produzione**, aggiornando voce, tempi e inquadrature. La mappa di orientamento è inclusa offline; il dettaglio online è facoltativo. Guida: [Revisione di testi, luoghi e immagini](docs/REVISIONE.md).
