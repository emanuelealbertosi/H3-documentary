...
La versione **1.7.1** rende più robusti i documentari basati su fonti caricate: usa più passaggi del documento, corregge le coordinate dei luoghi quando la fonte fornisce valori espliciti, normalizza l’audio WAV restituito dai server Higgs e adatta automaticamente il ritmo delle voci esterne alla durata richiesta. Al termine mostra anche il tempo totale di elaborazione, conservato attraverso interruzioni e riprese. La gestione introdotta nella 1.7.0 resta disponibile: **Rigenera nuova versione** conserva un documentario completato e crea V2, V3 e successive; **Rigenera da zero** archivia un tentativo non concluso; **Riprendi** usa i checkpoint esistenti; **Elimina** rimuove un progetto inattivo e i suoi file locali.
