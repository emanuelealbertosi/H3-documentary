...
La versione **1.7.0** aggiunge la gestione delle versioni direttamente nella pagina del progetto. **Rigenera nuova versione** conserva un documentario completato e crea V2, V3 e successive con gli stessi contenuti editoriali e la voce predefinita corrente. Su un progetto fallito o interrotto, **Rigenera da zero** archivia il tentativo e riavvia lo stesso progetto; **Riprendi** continua invece dai checkpoint esistenti. **Elimina** rimuove un progetto inattivo e i suoi file locali dopo una conferma esplicita. Il lifecycle Higgs verifica ora lo stato tramite una seconda chiamata al server dopo load e unload; l'interfaccia distingue questa conferma dallo stato effettivo della VRAM del computer remoto.
