...
La pagina del progetto mostra tutti gli slot con quattro stati: **Trovata automaticamente**, **Scheda neutra**, **Da completare** e **Personalizzata**. Ogni stato è sostituibile. Apri **Gestisci e sostituisci**, trascina una nuova immagine sul soggetto e premi **Rivedi e aggiorna questo video**. Si apre la revisione dello stesso progetto, senza creare V2/V3. Puoi correggere anche testo e luoghi, oppure premere direttamente **Aggiorna questo video**. Il motore riusa ricerca, audio e clip non coinvolte, aggiorna le scene interessate, quindi esegue nuovamente montaggio e verifica tecnica. Il vecchio film rimane disponibile fino alla sostituzione verificata e viene conservato in una copia locale. Dettagli e dipendenze della timeline in [Revisione](REVISIONE.md).
