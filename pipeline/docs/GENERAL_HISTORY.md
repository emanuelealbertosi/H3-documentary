...
I movimenti contengono punti, cue, fonti e `semantic`: migration, population_transfer, trade, sea_trade, cultural_diffusion, religious_diffusion, technology_diffusion, journey, exploration, connection, influence, attack, invasion, campaign, retreat, expansion. Il percorso è un nastro illustrato a tre livelli; il terminale è un segno di navigazione, una nave, un gruppo, un centro radiante o una punta militare secondo la semantica. Le traiettorie incerte restano tratteggiate. Spessore e simboli non indicano una popolazione. Le forme e il tratteggio dipendono soltanto dal tempo e dai dati della scena, senza campionamento casuale per fotogramma.
